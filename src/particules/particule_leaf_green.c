...
void particules_move_green3(game_t *game, sfVector2f vector)
{
...
void particules_move_green2(game_t *game, sfVector2f vector)
{
    ...
    particules_move_green3(game, vector);
}
...
void particules_move_green(game_t *game)
{
    ...
    sfSprite_setScale(game->scenes[TOWN].objs[LEAF_O_S1].sprite,
    (sfVector2f) {3.5, 3.5});
    ...
    particules_move_green2(game, vector);
}