...
void button_option6(game_scene_t *scenes, int enable, int disable)
{
    ...
    scenes[TOWN].texts[LIFE_T_S1].state = ((enable == 1) ? disable : enable);
    scenes[BOSS].texts[LIFE_T_S2].state = ((enable == 1) ? disable : enable);
    scenes[FOREST].texts[LIFE_T_S3].state = ((enable == 1) ? disable : enable);
    scenes[BEACH].texts[LIFE_T_S4].state = ((enable == 1) ? disable : enable);
    scenes[FOREST].texts[LIFE_T_S5].state = ((enable == 1) ? disable : enable);
}

void button_option5(game_scene_t *scenes, int enable, int disable)
{
    ...
    button_option6(scenes, 1, -1);
}

void button_option4(game_scene_t *scenes, int enable, int disable)
{
    ...
    button_option5(scenes, 1, -1);
}

void button_option3(game_scene_t *scenes, int enable, int disable)
{
    ...
    button_option4(scenes, 1, -1);
}

void button_option2(game_scene_t *scenes, int enable, int disable)
{
