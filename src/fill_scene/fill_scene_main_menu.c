...
{
    main_menu.buttons[NEW_B_S0] = new_button("assets/images/button_new.png",
...
{
    main_menu.objs[CURSOR_O_S0] = new_object("assets/images/cursor.png",
    (sfVector2f) {0, 0}, (sfIntRect) {0, 0, 30, 30}, 0);
    main_menu.buttons[LEFT_B_S0] = new_button("assets/images/left.png",
    (sfVector2f) {730, 390}, (sfIntRect) {0, 0, 44, 40}, -1);
    main_menu.buttons[RIGHT_B_S0] = new_button("assets/images/right.png",
    (sfVector2f) {795, 390}, (sfIntRect) {0, 0, 44, 40}, -1);
    main_menu.buttons[OK_B_S0] = new_button("assets/images/ok.png",
    ...
    main_menu.buttons[EXIT_B_S0] = new_button("assets/images/button_exit.png",
    (sfVector2f) {1100, 340}, (sfIntRect) {0, 0, 148, 122}, 0);
    main_menu.buttons[BACK_B_S0] = new_button("assets/images/button_back.png",
...
void fill_scene_main_menu1(game_scene_t main_menu)
{
    ...
    main_menu.objs[BG1_O_S0] = new_object("assets/images/menu_bg1.png",
    (sfVector2f) {0, 0}, (sfIntRect) {0, 0, 1920, 1080}, 0);
    main_menu.objs[CLOUD1_O_S0] = new_object("assets/images/cloud1.png",
    (sfVector2f) {20, 80}, (sfIntRect) {0, 0, 512, 341}, 1);
    main_menu.objs[CLOUD2_O_S0] = new_object("assets/images/cloud2.png",
    (sfVector2f) {1350, 120}, (sfIntRect) {0, 0, 133, 64}, 3);
    main_menu.objs[CLOUD3_O_S0] = new_object("assets/images/cloud2.png",
