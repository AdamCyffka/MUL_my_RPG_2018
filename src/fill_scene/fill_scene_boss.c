...
void fill_scene_boss3(game_scene_t boss)
{
    ...
    boss.sounds[MUSIC_S_S2] = new_sound("assets/sounds/music_boss.ogg", sfFalse, 100);
    boss.sounds[CLICK_S_S2] = new_sound("assets/sounds/click.ogg", sfFalse, 100);
    boss.sounds[WALK_S_S2] = new_sound("assets/sounds/walk_rock.ogg", sfFalse, 100);
    boss.sounds[SWORD_S_S2] = new_sound("assets/sounds/swoosh.ogg", sfFalse, 100);
