...
void fill_scene_victory(game_scene_t victory)
{
    ...
    victory.objs[LOGO_O_S6] = new_object("assets/logo.png",
    (sfVector2f) {0, 0}, (sfIntRect) {0, 0, 266, 104}, 0);
    victory.objs[BG_O_S6] = new_object("assets/menu_bg.png",
    (sfVector2f) {0, 0}, (sfIntRect) {0, 0, 1920, 1080}, 0);
    victory.objs[CURSOR_O_S6] = new_object("assets/cursor.png",
...
void fill_scene_defeat(game_scene_t defeat)
{
    ...
    (sfVector2f) {0, 0}, (sfIntRect) {0, 0, 266, 104}, 0);
    defeat.objs[BG_O_S7] = new_object("assets/menu_bg.png",
    (sfVector2f) {0, 0}, (sfIntRect) {0, 0, 1920, 1080}, 0);
